  ...
  const customerBookedRooms = rooms
    ...
    .map((room) => {
      return {
        ...
        "Start Time": room.customerDetails.startTime,
        "End Time": room.customerDetails.endTime,
        "Booking id": room.roomID,
        "Booking date": room.customerDetails.date,
        "Booking status": room.bookedStatus,
      };
    });
  response.send(customerBookedRooms);
});
